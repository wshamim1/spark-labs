"""
AWS S3 Read Operations with PySpark
...
def create_spark_session() -> SparkSession:
    ...
    conf = (SparkConf()
            .setAppName("S3_Read_Integration")
...
def main() -> None:
    ...
    try:
        # S3 path - Update with your bucket and path
        s3_path = os.getenv(
            "S3_INPUT_PATH",
            "s3a://streamsets-customer-success-internal/wilsonshamim/merck/test.json/"
        )
